...
class Builder {
	...
	public static function query_content_type_for_elements_html( $elements, $post_id ) {
		...
		foreach ( $elements as $element ) {
			...
			// Add attributes added via filter 'bricks/element/render_attributes' to builder (@since 1.10)
			// NOTE: Not in use as we collect attributes in render_attributes() method (@see base.php #2088)
			// $attributes = apply_filters( 'bricks/element/render_attributes', [], '_root', (object) $element );
			// if ( is_array( $attributes ) && count( $attributes ) ) {
			// self::$html_attributes[ $element['id'] ] = $attributes;
			// }
