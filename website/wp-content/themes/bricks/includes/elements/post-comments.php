...
class Element_Post_Comments extends Element {
	...
	public function comment_author_link( $comment_author_tag ) {
		return ! empty( $this->settings['commentAuthorTag'] ) ? esc_html( $this->settings['commentAuthorTag'] ) : $comment_author_tag;
	}
	...
	public function render() {
		...
		$title_tag = ! empty( $settings['titleTag'] ) ? esc_html( $settings['titleTag'] ) : 'h3';
